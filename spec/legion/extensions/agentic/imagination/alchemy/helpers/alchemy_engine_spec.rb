...
RSpec.describe Legion::Extensions::Agentic::Imagination::Alchemy::Helpers::AlchemyEngine do
  ...
  describe '#create_substance' do
    it 'creates and stores a substance' do
      sub = engine.create_substance(element_type: :belief, domain: :ethics,
                                    content: 'moral axiom')
      expect(sub).to be_a(Legion::Extensions::Agentic::Imagination::Alchemy::Helpers::Substance)
    end

    it 'raises when athanor is full' do
      stub_const('Legion::Extensions::Agentic::Imagination::Alchemy::Helpers::Constants::MAX_SUBSTANCES', 1)
  ...
  describe '#react' do
    it 'combines two substances' do
      ...
      expect(result[:output]).to be_a(Legion::Extensions::Agentic::Imagination::Alchemy::Helpers::Substance)
    ...
    it 'raises for too many reactions' do
      stub_const('Legion::Extensions::Agentic::Imagination::Alchemy::Helpers::Constants::MAX_REACTIONS', 0)
