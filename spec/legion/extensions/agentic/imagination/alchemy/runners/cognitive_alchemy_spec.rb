...
RSpec.describe Legion::Extensions::Agentic::Imagination::Alchemy::Runners::CognitiveAlchemy do
  let(:engine) { Legion::Extensions::Agentic::Imagination::Alchemy::Helpers::AlchemyEngine.new }
