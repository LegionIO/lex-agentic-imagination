...
RSpec.describe Legion::Extensions::Agentic::Imagination::Aurora::Helpers::AuroraEngine do
  ...
  describe '#spectral_distribution' do
    it 'returns a hash with all aurora types as keys' do
      ...
      expect(dist.keys).to match_array(Legion::Extensions::Agentic::Imagination::Aurora::Helpers::Constants::AURORA_TYPES)
    end
  ...
  describe '#aurora_report' do
    ...
    it 'includes spectral_distribution with all types' do
      expect(report[:spectral_distribution].keys).to match_array(
        Legion::Extensions::Agentic::Imagination::Aurora::Helpers::Constants::AURORA_TYPES
      )
    end
  end
  ...
  describe 'MAX_EVENTS pruning' do
    it 'prunes when event count reaches MAX_EVENTS' do
      max = Legion::Extensions::Agentic::Imagination::Aurora::Helpers::Constants::MAX_EVENTS
