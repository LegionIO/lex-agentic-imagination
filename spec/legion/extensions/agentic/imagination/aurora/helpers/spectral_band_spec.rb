...
RSpec.describe Legion::Extensions::Agentic::Imagination::Aurora::Helpers::SpectralBand do
  subject(:band) { described_class.new(aurora_type: :harmonic) }

  let(:bright_event) do
    Legion::Extensions::Agentic::Imagination::Aurora::Helpers::AuroraEvent.new(
  ...
  describe '#dominant_color' do
    it 'returns first spectral color for empty band' do
      expect(band.dominant_color).to eq(Legion::Extensions::Agentic::Imagination::Aurora::Helpers::Constants::SPECTRAL_COLORS.first)
    end
    ...
    it 'returns a valid spectral color' do
      ...
      expect(Legion::Extensions::Agentic::Imagination::Aurora::Helpers::Constants::SPECTRAL_COLORS).to include(band.dominant_color)
    end
  end
