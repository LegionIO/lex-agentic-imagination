...
RSpec.describe Legion::Extensions::Agentic::Imagination::Greenhouse::Client do
  subject(:client) { described_class.new }

  describe '#initialize' do
    it 'creates a default greenhouse' do
      expect(client.send(:greenhouse))
        .to be_a(Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Greenhouse)
    end

    it 'accepts a custom greenhouse' do
      custom = Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Greenhouse.new(season: :winter)
  ...
  describe 'full lifecycle integration' do
    it 'plants, grows, blooms, and harvests an idea through all stages' do
      ...
      custom_greenhouse = Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Greenhouse.new
      seedling = Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Seedling.new(
