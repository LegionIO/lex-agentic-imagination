...
RSpec.describe Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::GreenhouseEngine do
  subject(:engine) { described_class.new }

  describe '#initialize' do
    it 'creates a default greenhouse' do
      expect(engine.greenhouse).to be_a(Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Greenhouse)
    end

    it 'accepts an injected greenhouse' do
      custom = Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Greenhouse.new(season: :autumn)
  ...
  describe '#create_plant' do
    it 'returns a Seedling' do
      ...
      expect(plant).to be_a(Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Seedling)
    end
  ...
  describe '#greenhouse_report' do
    ...
    it 'returns plants_by_stage hash' do
      ...
      expect(report[:plants_by_stage].keys).to eq(Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Constants::GROWTH_STAGES)
    end
