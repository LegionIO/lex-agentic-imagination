...
RSpec.describe Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Greenhouse do
  subject(:greenhouse) { described_class.new }

  let(:seedling) do
    Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Seedling.new(
  ...
  describe '#plant!' do
    ...
    it 'refuses planting when at capacity' do
      stub_const('Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Constants::MAX_PLANTS', 1)
      greenhouse.plant!(seedling)
      second = Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Seedling.new(
  ...
  describe '#harvest_blooms' do
    before do
      bloom_seedling = Legion::Extensions::Agentic::Imagination::Greenhouse::Helpers::Seedling.new(
