...
RSpec.describe Legion::Extensions::Agentic::Imagination::Lucidity::Helpers::DreamState do
  subject(:state) do
  ...
  describe '#destabilize!' do
    ...
    it 'decays lucidity by LUCIDITY_DECAY constant' do
      s = described_class.new(theme: :test, content: 'x', lucidity_level: 0.5)
      s.destabilize!(0.1)
      expect(s.lucidity_level).to be_within(0.001).of(0.5 - Legion::Extensions::Agentic::Imagination::Lucidity::Helpers::Constants::LUCIDITY_DECAY)
    end
