...
RSpec.describe Legion::Extensions::Agentic::Imagination::Lucidity::Helpers::JournalEntry do
  let(:dream_state) do
    s = Legion::Extensions::Agentic::Imagination::Lucidity::Helpers::DreamState.new(
      theme:          :ocean,
