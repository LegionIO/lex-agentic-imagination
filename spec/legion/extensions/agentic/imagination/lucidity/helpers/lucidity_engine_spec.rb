...
RSpec.describe Legion::Extensions::Agentic::Imagination::Lucidity::Helpers::LucidityEngine do
  ...
  describe '#begin_dream' do
    ...
    it 'evicts oldest dream when MAX_DREAMS exceeded' do
      stub_const('Legion::Extensions::Agentic::Imagination::Lucidity::Helpers::Constants::MAX_DREAMS', 2)
  ...
  describe '#end_dream' do
    ...
    it 'caps journal at MAX_JOURNAL_ENTRIES' do
      stub_const('Legion::Extensions::Agentic::Imagination::Lucidity::Helpers::Constants::MAX_JOURNAL_ENTRIES', 2)
      3.times do
