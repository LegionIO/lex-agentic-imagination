...
RSpec.describe Legion::Extensions::Agentic::Imagination::Origami::Helpers::Figure do
  ...
  describe '#fold!' do
    ...
    it 'returns a Crease' do
      ...
      expect(crease).to be_a(Legion::Extensions::Agentic::Imagination::Origami::Helpers::Crease)
    end
    ...
    it 'raises ArgumentError when exceeding MAX_FOLDS' do
      max = Legion::Extensions::Agentic::Imagination::Origami::Helpers::Constants::MAX_FOLDS
    ...
    it 'accepts all valid fold types' do
      Legion::Extensions::Agentic::Imagination::Origami::Helpers::Constants::FOLD_TYPES.each_with_index do |ft, i|
