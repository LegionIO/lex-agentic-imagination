...
RSpec.describe Legion::Extensions::Agentic::Imagination::Origami::Helpers::OrigamiEngine do
  ...
  describe '#create_figure' do
    it 'creates and returns a Figure' do
      figure = create_fig
      expect(figure).to be_a(Legion::Extensions::Agentic::Imagination::Origami::Helpers::Figure)
    end
    ...
    it 'raises ArgumentError when MAX_FIGURES is reached' do
      max = Legion::Extensions::Agentic::Imagination::Origami::Helpers::Constants::MAX_FIGURES
