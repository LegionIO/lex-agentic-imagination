...
RSpec.describe Legion::Extensions::Agentic::Imagination::Origami::Runners::CognitiveOrigami do
  let(:engine) { Legion::Extensions::Agentic::Imagination::Origami::Helpers::OrigamiEngine.new }
