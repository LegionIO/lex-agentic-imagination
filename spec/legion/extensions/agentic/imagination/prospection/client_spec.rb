...
RSpec.describe Legion::Extensions::Agentic::Imagination::Prospection::Client do
  ...
  it 'exposes the prospection engine' do
    expect(client.prospection_engine).to be_a(Legion::Extensions::Agentic::Imagination::Prospection::Helpers::ProspectionEngine)
  end

  it 'accepts an injected prospection engine' do
    engine = Legion::Extensions::Agentic::Imagination::Prospection::Helpers::ProspectionEngine.new
