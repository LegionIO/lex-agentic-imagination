...
RSpec.describe Legion::Extensions::Agentic::Imagination::Prospection::Helpers::ProspectionEngine do
  let(:engine)    { described_class.new }
  let(:constants) { Legion::Extensions::Agentic::Imagination::Prospection::Helpers::Constants }
  ...
  describe '#imagine' do
    it 'creates and returns a Scenario' do
      ...
      expect(s).to be_a(Legion::Extensions::Agentic::Imagination::Prospection::Helpers::Scenario)
    end
