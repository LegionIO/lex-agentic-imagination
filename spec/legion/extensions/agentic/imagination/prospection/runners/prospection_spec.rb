...
RSpec.describe Legion::Extensions::Agentic::Imagination::Prospection::Runners::Prospection do
  let(:client) { Legion::Extensions::Agentic::Imagination::Prospection::Client.new }
