...
RSpec.describe Legion::Extensions::Agentic::Imagination::Volcano::Client do
  ...
  describe '#initialize' do
    it 'creates a VolcanoEngine by default' do
      expect(client.engine).to be_a(Legion::Extensions::Agentic::Imagination::Volcano::Helpers::VolcanoEngine)
    end

    it 'accepts an injected engine' do
      engine = Legion::Extensions::Agentic::Imagination::Volcano::Helpers::VolcanoEngine.new
