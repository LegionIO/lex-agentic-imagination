...
RSpec.describe Legion::Extensions::Agentic::Imagination::Volcano::Helpers::Chamber do
  let(:constants) { Legion::Extensions::Agentic::Imagination::Volcano::Helpers::Constants }
  let(:magma_class) { Legion::Extensions::Agentic::Imagination::Volcano::Helpers::Magma }
