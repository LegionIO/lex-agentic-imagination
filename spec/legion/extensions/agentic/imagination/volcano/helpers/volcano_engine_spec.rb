...
RSpec.describe Legion::Extensions::Agentic::Imagination::Volcano::Helpers::VolcanoEngine do
  ...
  describe '#create_magma' do
    it 'creates and returns a Magma instance' do
      magma = add_magma
      expect(magma).to be_a(Legion::Extensions::Agentic::Imagination::Volcano::Helpers::Magma)
    end
  ...
  describe '#create_chamber' do
    it 'creates and returns a Chamber instance' do
      chamber = add_chamber
      expect(chamber).to be_a(Legion::Extensions::Agentic::Imagination::Volcano::Helpers::Chamber)
    end
    ...
    it 'raises ArgumentError at MAX_CHAMBERS limit' do
      stub_const('Legion::Extensions::Agentic::Imagination::Volcano::Helpers::Constants::MAX_CHAMBERS', 2)
      add_chamber(name: 'c1')
      add_chamber(name: 'c2')
