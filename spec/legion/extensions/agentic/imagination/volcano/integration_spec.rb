...
RSpec.describe 'CognitiveVolcano integration' do
  let(:constants)  { Legion::Extensions::Agentic::Imagination::Volcano::Helpers::Constants }
  let(:magma_cls)  { Legion::Extensions::Agentic::Imagination::Volcano::Helpers::Magma }
  let(:chamber_cls) { Legion::Extensions::Agentic::Imagination::Volcano::Helpers::Chamber }
  let(:engine)     { Legion::Extensions::Agentic::Imagination::Volcano::Helpers::VolcanoEngine.new }
  let(:client)     { Legion::Extensions::Agentic::Imagination::Volcano::Client.new(engine: engine) }
  ...
  describe 'runner via module extend' do
    it 'create_magma and list_chambers work from the runner module directly' do
      runner = Object.new
      runner.extend(Legion::Extensions::Agentic::Imagination::Volcano::Runners::CognitiveVolcano)
